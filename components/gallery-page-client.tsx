...
export function GalleryPageClient({
  ...
  function updateFilters(next: Partial<Filters>) {
    ...
    if (nextFilters.skinType !== "all") params.set("skinType", nextFilters.skinType)
    if (nextFilters.skinTone !== "all") params.set("skinTone", nextFilters.skinTone)
    if (nextFilters.concern !== "all") params.set("concern", nextFilters.concern)
        ...
        <section className="soft-shadow glass-panel rounded-[32px] border border-border/80 px-6 py-8 md:px-8">
          <div className="flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
              ...
              <MetricCard label="Tones" value={String(Object.keys(toneCounts).length)} />
              <MetricCard
                label="Consent"
